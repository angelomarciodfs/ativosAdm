...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white border border-gray-200 p-8 rounded-2xl shadow-xl relative z-10">
        <div className="flex flex-col items-center justify-center mb-10">
           ...
           <div className="text-center mt-4">
             ...
             <p className="text-gray-500 text-sm font-medium leading-tight mt-1">Rota da luz</p>
           </div>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          >
            {loading ? <Loader className="animate-spin" size={18} /> : <>Acessar Sistema <ArrowRight size={18} /></>}
          </button>
        </form>

        <div className="mt-8 pt-6 border-t border-gray-100 text-center">
           <p className="text-xs text-gray-400">Entre com seu usuário Supabase.</p>
        </div>
      </div>
    </div>
  );
